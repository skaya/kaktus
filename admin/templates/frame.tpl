...
<body onLoad="{if $cur_page==main}{ajax_update update_id="tree_container" function="select_subtree" params="id=0"}{/if}">
  ...
  <table>
  	<tr>
        ...
        <td width="73%" id="main_content" valign="top">
  			  <table cellpadding="0" cellspacing="0" width="100%">
            {include file="page_top.tpl"}
   	 		    <tr>
          		<td colspan="2" align="left">
                {section loop=$langs name=l}
                  {assign var=field value=text_$langs[l]}

                {/section}
                <input type="button" onClick="document.getElementById('page_templ').submit()"  value="Сохранить" id="save_but">
              </td>
       		  </tr>
   		    </table>
          <a href="#">
            <img src="admin_img/resize_bigger.gif" width="9" height="9" vspace="1" hspace="1" id="main_resizer" onClick="resize('main_content','main_resizer','garmoshka','garmoshka_resizer');">
          </a>
     	  </td>
      </form>
