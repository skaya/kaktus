...
<td align="center"><a href="#"  onclick="{ajax_update update_id="garmoshka" url="garmoshka.php" function="change_rank" params="part=files&issue_id=$issue_id&id=$id&how=up&page=$page&garmoshka_set_name=$garmoshka_set_name&table=files_to_pages&link_id=$link_id&parent_name=page_id&parent_value=$issue_id"};" target="_self" title="переместить на однупозицию ВВЕРХ" ><img src='admin_img/up.gif' width="5" height="8" hspace="1" vspace="1" align="top"  ></a>

 <a href="#" onclick="{ajax_update update_id="garmoshka" url="garmoshka.php" function="change_rank" params="part=files&issue_id=$issue_id&id=$id&how=down&page=$page&garmoshka_set_name=$garmoshka_set_name&table=files_to_pages&link_id=$link_id&parent_name=page_id&parent_value=$issue_id"};" target="_self"  title="переместить на однупозицию ВНИЗ" ><img src='admin_img/down.gif' width="5" height="8" hspace="0" vspace="0" align="bottom"  style="top:3px; left:-3px; position:relative"></a>
</td>
...
javascript:check('объект ' +'{$objects[obj].name}', garmoshka,'delete_file','garmoshka.php','to_delete={$objects[obj].id}&part=files&issue_id={$issue_id}&garmoshka_set_name={$garmoshka_set_name}');" title="удалить" ><img src='admin_img/delete_sm.gif' width="9" height="9" ></a>
<a onclick="{ajax_update update_id="garmoshka" function="unlink_file" params="link_to=$issue_id&id=$id&part=files&issue_id=$issue_id&garmoshka_set_name=$garmoshka_set_name"};" title="удалить" ><img src='admin_img/unlink.gif' width="18" height="13" ></a>
</td>
</tr> 
{/section}
</table>
