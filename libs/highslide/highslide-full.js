...
lang : {
	...
	focusTitle : 'На первый план',
	fullExpandTitle : 'Увеличить до реального разммера (f)',
	creditsTitle : '',
	previousText : 'Назад',
	nextText : 'Вперед', 
	...
	resizeTitle : 'Масштабировать',
	playText : 'Начать слайдшоу',
	playTitle : 'Начать слайдшоу (space)',
	pauseText : 'Пауза',
	pauseTitle : 'Приостановить слайдшоу (space)',
	previousTitle : 'Предыдущее изобрадение (<-)',
	nextTitle : 'Следующее изображение (->)',
	moveTitle : 'Передвинуть',
	fullExpandText : '1:1',
	number: 'Изображение %1 из %2',
	restoreTitle : 'Кликните, чтобы закрыть изображение, перетяните, чтобы изменить место положения. Используйте стрелки для просмотра.'
},
// See http://highslide.com/ref for examples of settings  
graphicsDir : 'libs/highslide/graphics/',
...
htmlExpand : function(a, params, custom) {
	return hs.expand(a, params, custom, 'body');
},
...
init : function () {
	if (!hs.container) {
       ...
       if(xScroll < windowWidth){
		...
		//alert(windowWidth);
		if (windowWidth-1340 < 0) offs = 0;
		else offs = (windowWidth-1340)/2*(-1);
...
hs.addEventListener(window, 'resize', hs.ready);
